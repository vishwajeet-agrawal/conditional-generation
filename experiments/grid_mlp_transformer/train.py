...
if __name__ == '__main__':
    ...
    if args.multiple:
        ...
        if os.path.exists(args.results):
            ...
            results_pd = results_pd.loc[:, ~results_pd.columns.str.contains('^Unnamed')]
            results_f = results_pd[['n_features','datapath','embedding_dim','aggregator','n_layers','n_heads','reduce_type','learn_adjacency','tie_embeddings','tie_aggregator']]
        ...
        for j, r in data_configs.iterrows():
            ...
            for i, row in tqdm(configs.iterrows()):
                ...
                if row_.to_dict('records')[0] in results_f:
                    continue
